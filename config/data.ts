...
const DEFAULT_AVATAR = 'https://api.dicebear.com/7.x/avataaars/svg?seed=Portfolio&backgroundColor=b6e3f4';
...
const createTag = (id: number, name: string): Tag => ({
    id, name, slug: slugify(name), description: `${name} related content`,
    color: undefined, usageCount: 1, isActive: true, createdAt, updatedAt: createdAt,
});
...
const experience: ResumeContent[] = [
    {
        ...
        content: '- Led development of cloud-native applications.\n- Mentored junior developers and improved code quality.\n- Architected scalable backend systems using Node.js.',
        slug: 'senior-developer', company: 'Tech Solutions Inc.', location: 'Remote', category: 'Full-Time',
    },
    {
        id: 2,
...
const projects: ResumeContent[] = [
    {
        id: 11,
        title: 'Project Alpha', type: ResumeContentType.PROJECT, status: 'published',
        date: '2023-01-01T00:00:00.000Z',
        tags: [createTag(11, 'React'), createTag(12, 'Next.js'), createTag(13, 'PostgreSQL')],
        excerpt: 'A comprehensive management system for small businesses to track inventory and sales.',
        content: '- Real-time inventory tracking.\n- Sales reporting and analytics.\n- Multi-user support with role-based access.',
        slug: 'project-alpha', liveUrl: 'https://example.com/project-alpha', repoUrl: 'https://github.com/johndoe/project-alpha', category: 'featured',
    },
    {
        id: 12, title: 'Beta App', type: ResumeContentType.PROJECT, status: 'published',
        ...
        content: '- Location-based matching.\n- Instant messaging.\n- Lightweight moderation and community tooling.',
        slug: 'beta-app', liveUrl: 'https://example.com/beta-app', repoUrl: 'https://github.com/johndoe/beta-app', category: 'featured',
    },
];

const education: ResumeContent[] = [
    {
        id: 21, title: 'Master of Science in Computer Science', type: ResumeContentType.EDUCATION,
        status: 'published', date: '2020-01-01T00:00:00.000Z', tags: [],
        ...
        slug: 'master-of-science-in-computer-science', company: 'University of Tech',
    },
    {
        id: 22, title: 'Bachelor of Science in Information Technology', type: ResumeContentType.EDUCATION,
        status: 'published', date: '2018-01-01T00:00:00.000Z', tags: [],
        ...
        slug: 'bachelor-of-science-in-information-technology', company: 'State University',
    },
];

const skills: ResumeContent[] = [
    ['JavaScript', 'Tech Stack'], ['TypeScript', 'Tech Stack'], ['React', 'Tech Stack'],
    ['Next.js', 'Tech Stack'], ['Node.js', 'Tech Stack'], ['PostgreSQL', 'Tech Stack'],
    ['Tailwind CSS', 'Tech Stack'], ['Git', 'Tools'], ['Docker', 'Tools'],
    ['VS Code', 'Tools'], ['Postman', 'Tools'],
].map(([title, category], index) => ({
    id: 100 + index, title, type: ResumeContentType.SKILL, status: 'published',
    date: '2024-01-01T00:00:00.000Z', tags: [], excerpt: `${title} experience`,
    content: `${title} is part of the day-to-day toolkit.`, slug: slugify(title), category, proficiency: 85,
}));

const strengths: ResumeContent[] = [
    'Problem Solving', 'Architecture Design', 'Team Leadership', 'Communication',
].map((title, index) => ({
    id: 200 + index, title, type: ResumeContentType.STRENGTH, status: 'published',
    date: '2024-01-01T00:00:00.000Z', tags: [], excerpt: title, content: title, slug: slugify(title),
}));

const languages: ResumeContent[] = (
    [['English', 'fluent'], ['Spanish', 'basic']] as [string, ResumeContent['proficiencyLevel']][]
).map(([title, proficiencyLevel], index) => ({
    id: 300 + index, title, type: ResumeContentType.LANGUAGE, status: 'published',
    date: '2024-01-01T00:00:00.000Z', tags: [], excerpt: `${title} proficiency`,
    content: title, slug: slugify(title), proficiencyLevel,
}));
...
export const publicPortfolioData: PublicPortfolioData = {
    ...
    resume: {
        ...
        awards: [], testimonials: [], languages, strengths,
    },
    seo: {
        title: publicSiteData.title, description: publicSiteData.description,
        keywords: publicSiteData.keywords, ogImage: publicSiteData.ogImage,
        siteName: publicSiteData.name, baseUrl: publicSiteData.baseUrl,
        author: publicSiteData.author, twitterHandle: publicSiteData.twitterHandle,
    },
